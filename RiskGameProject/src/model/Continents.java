...
public class Continents {
	...
	/**
	 * The continentControlValue variable contains the continent control value
	 * The continentColour variable contains the continent colour
	 * The continentName variable contains the continent name
	 */
