...
public class Countries {
	...
	/**
	 * The countryName variable contains the country name
	 * The countryContinentNum variable contains the country continent number
	 * The xCoordinate variable contains the x coordinate
	 * The yCoordinate variable contains the y coordinate
