...
public class GameMap {
	...
	/**
	 * The continents variable contains hashmap of continents The countries variable
	 * contains hashmap of countries The boundries variable contains hashmap of
	 * boundaries The totalCardsList variable contains arraylist of total cards list
	 * The playersSetup variable contains arraylist of players setup The
	 * playersWithStrategies variable contains hashmap of players with strategies
	 * The fileType variable contains the file type
	 */
